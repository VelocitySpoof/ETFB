				...
				do
					...
					table.insert(
						...
						UserInputService.InputBegan:Connect(function(key)
							if
								(key.UserInputType == Enum.UserInputType.MouseButton1 or key.UserInputType == Enum.UserInputType.Touch)
								and Slider.Hover
				...
				do
					...
					function Dropdown:AddItem(value)
						...
						table.insert(
							ConnectionBin,
							UserInputService.InputBegan:Connect(function(input)
								if (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch) and DropdownOption.Hover then
									Library:PlaySound(LibSettings.ClickSound)
									Library:Tween(DropdownOption["50"], {
										Length = 0.2,
										Goal = { Color = Color3.fromRGB(86, 86, 86) },
		...
		table.insert(
			...
			UserInputService.InputBegan:Connect(function(input)
				if Library.MainFrameHover then
					if (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch) and not Library.Sliding then
